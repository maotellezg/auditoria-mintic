...
export default function Dashboard({ onSelectDoc }) {
  ...
  const handleDownloadAll = async () => {
    ...
    try {
      ...
      const zipFileName = `Entrega_Documental_ANLA_MinAmbiente_${timestamp}.zip`;
        ...
        <div className="glass-panel" style={{ padding: '32px', borderColor: 'var(--color-error)', background: 'rgba(239, 68, 68, 0.03)' }}>
          ...
          <div style={{ borderTop: '1px solid var(--border-color)', paddingTop: '20px' }}>
            ...
            <ol style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '12px', lineHeight: '1.6', margin: 0 }}>
              <li>
                Ingresa a la <strong><a href="https://console.firebase.google.com/" target="_blank" rel="noreferrer" style={{ color: 'var(--color-accent)', textDecoration: 'underline' }}>Consola de Firebase</a></strong> y selecciona tu proyecto <code>entrega-anla</code>.
              </li>
              <li>
