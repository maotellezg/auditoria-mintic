...
export async function analyzeDocument(fileBuffer, filename, mimeType, gcsPath = null) {
  ...
  if (mimeType === 'application/vnd.openxmlformats-officedocument.wordprocessingml.document') {
    ...
    if (gcsPath) {
      const bucketName = process.env.GCP_STORAGE_BUCKET || 'entrega-anla';
  ...
  const promptText = `
Eres un analista experto de la ANLA (Autoridad Nacional de Licencias Ambientales) de Colombia.
